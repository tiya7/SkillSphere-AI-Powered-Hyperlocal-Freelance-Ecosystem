...
const recentGigs = [
  { title: 'React Dashboard UI', freelancer: 'Upcoming', status: 'active', budget: '₹0' },
  { title: 'Node.js API Development', freelancer: 'Upcoming', status: 'review', budget: '₹0' },
  { title: 'Logo Design', freelancer: 'Upcoming', status: 'completed', budget: '₹0' },
];
  ...
  return (
    <div className="page-enter">
      ...
      <div className="stats-grid" style={{ marginBottom: '32px' }}>
        {[
          { label: 'Active Gigs', value: '0', icon: Briefcase, color: '#dbeafe', iconColor: 'var(--brand-600)', change: '-' },
          { label: 'Hired Freelancers', value: '0', icon: Users, color: '#d1fae5', iconColor: 'var(--success)', change: '-' },
          { label: 'Total Spent', value: '₹0.0L', icon: CreditCard, color: '#fef3c7', iconColor: 'var(--warning)', change: '-' },
          { label: 'Avg. Rating Given', value: '0.0', icon: Star, color: '#ede9fe', iconColor: '#7c3aed', change: '-' },
      ...
      <div style={{ marginTop: '24px', padding: '24px', background: 'linear-gradient(135deg, var(--brand-600), var(--brand-900))', borderRadius: 'var(--radius-xl)', color: 'white' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <div style={{ display: 'flex', gap: '12px' }}>
            ...
            <Link to="/gigs/new" style={{ background: 'white', color: 'var(--brand-700)', padding: '10px 20px', borderRadius: 'var(--radius-md)', fontSize: '14px', fontWeight: '600', display: 'inline-flex', alignItems: 'center', gap: '8px', textDecoration: 'none' }}>
              <Plus size={16} /> Post a Gig
            </Link>
          </div>
        </div>
