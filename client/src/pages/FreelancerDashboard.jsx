  ...
  return (
    <div className="page-enter">
      ...
      <div className="stats-grid" style={{ marginBottom: '32px' }}>
        {[
          { label: 'Total Earnings', value: '₹-', icon: DollarSign, color: '#d1fae5', iconColor: 'var(--success)', change: '-' },
          { label: 'Active Projects', value: '-', icon: Briefcase, color: '#dbeafe', iconColor: 'var(--brand-600)', change: '-' },
          { label: 'Reputation Score', value: '-', icon: Star, color: '#fef3c7', iconColor: 'var(--warning)', change: '-' },
          { label: 'Profile Views', value: '-', icon: Eye, color: '#ede9fe', iconColor: '#7c3aed', change: '-' },
